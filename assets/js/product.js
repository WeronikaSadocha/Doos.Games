    ...
    [
        {
            ...
            image: 'arkham.jpg',
            rating: 8.2,
            info: ['Number of players: 1-9','Playing time: 120min-240min', 'Age:14+', 'Complexity rating:3.58/5'],
    ...
    
        {
            ...
            image: 'wingspan.jpg',
            rating:8.1 ,
            info: ['Number of players: 1-5','Playing time: 40min-70min', 'Age:10+', 'Complexity rating:2.44/5'],
        ...
        {   
            ...
            image: 'brass.jpg',
            rating: 8.7 ,
            info: ['Number of players: 2-4','Playing time: 60min-120min', 'Age:14+', 'Complexity rating:3.90/5'],
        ...
        },
        {
            ...
            image: 'everdell.png',
            rating: 8.1 ,
            info: ['Number of players: 1-4','Playing time: 40min-80min', 'Age:10+', 'Complexity rating:2.82/5'],
        ...
        },
        {
            ...
            image: 'duel.jpg',
            rating: 8.1 ,
            info: ['Number of players: 2','Playing time: 30', 'Age:10+', 'Complexity rating:2.23/5'],
            description:"What's different about 7 Wonders Duel is that, as the title suggests, the game is solely for two players, with the players not drafting cards simultaneously from hands of cards, but from a display of face-down and face-up cards arranged at the start of a round. A player can take a card only if it's not covered by any others, so timing comes into play as well as bonus moves that allow you to take a second card immediately. As in the original game, each card that you acquire can be built, discarded for coins, or used to construct a wonder.",
            quantity: 0,
        },
        {
            name: 'Root',
        ...
        },
        {
            ...
            rating: 8.4 ,
            info: ['Number of players: 1-5','Playing time: 120min-240min', 'Age:14+', 'Complexity rating:3.24/5'],
        ...
        },
        {
            ...
            image: 'scythe.jpg',
            rating: 8.2 ,
            info: ['Number of players: 1-5','Playing time: 90- 115min', 'Age:12+', 'Complexity rating:3.42/5'],
        ...
        },
        {
            ...
            image: 'azul.jpg',
            rating: 7.8,
            info: ['Number of players: 2-4','Playing time: 30min-45min', 'Age:8+', 'Complexity rating:1.76/5'],
        ...
        },
        {
            ...
            rating: 8.1 ,
            info: ['Number of players: 2-5','Playing time: 60min-150min', 'Age:12+', 'Complexity rating:3.97/5'],
