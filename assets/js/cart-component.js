...
<div> 
    <div class= "cart-items" :class="{toggle:!isActive, fadeInImage:isActive}">
        ...
        <p id= "total-price" v-if=" cart.length > 0"> The total price is: {{arraySum}}</p>
        ...
        <ul class="inlineblock-list">
          ...
          <div class="basket"> 
              <div id="amount-in-basket" v-if=" cart.length > 0">{{cart.length}}</div>
                ...
                xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-basket3-fill" viewBox="0 0 16 16">
